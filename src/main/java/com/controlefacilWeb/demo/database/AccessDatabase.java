...
public class AccessDatabase {
     ...
     *
     * @param cliente nome do cliente (usado apenas no modo 1 para selecionar o arquivo)
    ...
    public Connection conectar(String cliente) throws Exception {
        switch (Login.conexao) {
            ...
            case 2: {
                ...
                String db     = conf.getProperty("pg.local.database", "ultrabarber");
     ...
     *
     * Se a chave {@code db.path} estiver definida, usa o caminho absoluto diretamente.
     * Caso contrário, constrói o caminho como {@code C:/Sistemas/BD/Bragasi/{cliente}.accdb}
